...
\includegraphics[scale=0.15]{BILDER-PTB0/Berliner-wasserbetriebe.svg.png}\hfill % \hfill sorgt dafür, dass die beiden Logos links und rechts stehen
\includegraphics[scale=0.25]{BILDER-PTB0/Hochschule_für_Wirtschaft_und_Recht_Berlin_logo.jpg} \\[0.7cm] % \\[1.8cm] fügt einen vertikalen Abstand von 1.8 cm nach den Bildern ein

% --- Titel (fette und große Schrift) ---
\Large{\textbf{Erstellung eines Soll-Prozesses und prototypische Umsetzung der Datenlöschung im SAP HCM zur Einhaltung der DSGVO am Beispiel der Berliner Wasserbetriebe}} \\[0.3cm]
    \doublespacing % Verdoppelt den Zeilenabstand

% --- Untertitel ---
{\Large Praxistransferbericht I} \\
...
\begin{tabular}{p{8cm} p{8cm}}
    ...
    \includegraphics[width=5.7cm]{BILDER-PTB0/unterschrift_nicole.png} &
    \includegraphics[width=4cm]{BILDER-PTB0/unterschrift_max.png} \\[0.1cm]
...
\newpage
\phantomsection
\addcontentsline{toc}{subsection}{Anhang 1: Erstellung eines Löschkonzepts}
\label{sec:Anhang1}
...
\begin{tabular}{p{8cm}}
    ...
    \includegraphics[width=5.5cm]{BILDER-PTB0/unterschrift_nicole.png} \\
