...
\subsection{Begriff und Ziele des Projektscontrollings}
Um das Projektcontrolling einzuordnen, sind vorab zwei Begriffe nötig. Ein Projekt ist nach DIN 69901 „ein Vorhaben, das im Wesentlichen durch die Einmaligkeit der Bedingungen in ihrer Gesamtheit gekennzeichnet ist" (zit. nach Fiedler 2020, S. 2), also keine Routineaufgabe, sondern zeitlich begrenzt, mit beschränkten Ressourcen, festgelegtem Ziel und meist hoher Unsicherheit (Fiedler 2020, S. 2 f.). Das Projektmanagement bildet die Grundlage, um ein Projekt jederzeit überblicken und steuern zu können, und umfasst die Führungsaufgaben für Initiierung, Definition, Planung, Steuerung und Abschluss von Projekten (Fiedler 2020, S. 5). Seine Ziele werden im „magischen Dreieck" aus Sachzielen (Leistung/Qualität), Terminzielen und Kostenzielen zusammengefasst, die sich gegenseitig beeinflussen (Fiedler 2020, S. 6).

Das Controlling selbst unterstützt die Unternehmensführung bei Planung und Kontrolle und versorgt das Management mit entscheidungsrelevanten Informationen (Fiedler 2020, S. 8). Auf dieser Basis lässt sich das Projektcontrolling bestimmen.

Die DIN 69901 beschreibt das Projektcontrolling als Regelkreis zur „Sicherung des Erreichens der Projektziele durch: Soll-Ist-Vergleich, Feststellung der Abweichungen, Bewerten der Konsequenzen und Vorschlagen von Korrekturmaßnahmen, Mitwirkung bei der Maßnahmenplanung und Kontrolle der Durchführung" (zit. nach Fiedler 2020, S. 8). Projektcontrolling ist dabei nicht nur Kostenkontrolle, sondern eine umfassende Unterstützungsfunktion für das Projektmanagement (Fiedler 2020, S. 10).

Zusammenfassend lässt es sich so charakterisieren: Projektcontrolling unterstützt das Projektmanagement bei der Gestaltung und laufenden Abstimmung der strategischen und operativen Projektmanagementaufgaben, insbesondere bei der Projektplanung und -kontrolle, und sichert so die Rationalität des Projektmanagements (Fiedler 2020, S. 11 f.). Es kümmert sich zunächst um die grundlegende Gestaltung der Strukturen und Prozesse, legt die Planungs- und Kontrollaufgaben fest und bestimmt die verantwortlichen Stellen (Fiedler 2020, S. 10). Die Verantwortung ist dabei klar verteilt: Während der Projektleiter das wirtschaftliche Ergebnis, die Leistung und die Termine verantwortet, ist der Projektcontroller vor allem für die Transparenz der Daten zuständig (Fiedler 2020, S. 15).

\subsection{Klassisches Projektcontrolling}
Auf Basis der festgelegten Strukturen übernimmt das Projektcontrolling die laufende Unterstützung der Projektmanagementaufgaben (Koordination) und gewährleistet die Verbindung von Projektplanung, -steuerung und -kontrolle mit dem Unternehmenscontrolling, da die Projektdaten Erfolg und Liquidität des Unternehmens erheblich beeinflussen (Fiedler 2020, S. 11).
Ein ganzheitliches Projektcontrolling lässt sich in drei Bausteine gliedern (Fiedler 2020, S. 12):
\begin{itemize}
    \setlength\itemsep{0.4\baselineskip}
    \setlength\parskip{0pt}
    \setlength\parsep{0pt}
    \item \textbf{Einzelprojektcontrolling:} Es unterstützt das Projektmanagement so, dass ein Projekt hinsichtlich Qualität und Funktionalität, Kosten und Zeit erfolgreich abgewickelt wird; es ist auf die Gesamtlaufzeit eines Projektes bezogen und damit kalenderunabhängig.
    \item \textbf{Operatives Multiprojektcontrolling:} Hier werden mehrere Projekte mit unterschiedlichen Terminen und Fertigstellungsständen für eine Abrechnungsperiode zusammengefasst betrachtet, etwa unter Beachtung der Kapazitäten sowie der Kosten- und Finanzwirkungen.
    \item \textbf{Strategisches Projektcontrolling (auch Portifolio-Controlling):} Es unterstützt vor allem die Projektbewertung, Projektpriorisierung und Projektauswahl (Fiedler 2020, S. 13).
  \end{itemize}
Die Instrumente des Multiprojektcontrollings entsprechen im Prinzip denen des Einzelprojektcontrollings, nur dass mehrere Projekte gleichzeitig verdichtet betrachtet werden (Fiedler 2020, S. 13). Wer das Projektcontrolling übernimmt, hängt von den betrieblichen Gegebenheiten und der Art des Projektes ab: In kleinen Projekten übernimmt häufig der Projektleiter selbst die Controllingaufgaben, während in größeren Projekten eigene Projektcontrolling-Stellen eingerichtet werden, die den Projektleiter entlasten (Fiedler 2020, S. 14). Als Träger kommen neben dem Projektleiter (Selbstcontrolling) auch eigene oder fremde Controller, andere Abteilungen oder externe Controller in Betracht (Fiedler 2020, S. 15 f.).

Die Einführung eines Projektcontrollings sollte „engpassbezogen" erfolgen – also nicht von Anfang an ein allumfassendes System anstreben, sondern zunächst nur kritische Aufgaben unterstützen (Fiedler 2020, S. 21). Aufgaben und Methoden orientieren sich am Reifegrad des vorhandenen Projektmanagements; das Capability Maturity Model unterscheidet dafür fünf Stufen: Initial, Managed, Defined, Quantitatively Managed und Optimizing (Fiedler 2020, S. 21 f.). Bei geringem Reifegrad kümmert sich das Projektcontrolling zunächst um die Beseitigung der größten Defizite und übernimmt mit zunehmender Reife weitere Aufgaben (Fiedler 2020, S. 22).

\subsection{Agiles Projektmanagement und agiles Controlling}


\subsection{Unterschiede zwischen Wasserfallmodell und agilem Vorgehen}
