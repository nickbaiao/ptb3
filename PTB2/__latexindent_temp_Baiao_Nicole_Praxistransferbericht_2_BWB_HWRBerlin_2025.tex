...
Vor diesem Hintergrund gewinnt die Nutzung von Cloud-Software zunehmend an Bedeutung. Am Beispiel der Adobe Creative Cloud zeigt sich, dass moderne KI-Funktionalitäten\footnote{Vgl. \cite{S_AdobeAI}, \cite{S_AdobeCloud}.} erhebliche Chancen für Effizienzsteigerungen bieten, gleichzeitig jedoch auch Risiken mit sich bringen.\footnote{Vgl. \cite{S_Ambient}.} Besonders relevant ist die Frage, wie bestehende Softwareprodukte erweitert und skaliert werden können, ohne dass eine vollständige Neubeschaffung erforderlich wird.
...
Zusammenfassend lässt sich festhalten, dass ITIL bei Software-Erweiterungen unterstützt, indem es Änderungen strukturiert, steuert und Risiken reduziert.
