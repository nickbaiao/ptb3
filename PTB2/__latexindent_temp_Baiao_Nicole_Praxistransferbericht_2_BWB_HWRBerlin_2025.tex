...
Es werden drei Arten von Änderungen unterschieden: Standard Changes mit bekannten Abläufen und geringem Risiko, Normal Changes, die ein vollständiges Prüfverfahren durchlaufen müssen, und Emergency Changes, die sofort umgesetzt werden, etwa bei Sicherheitslücken. Wichtige Rollen sind der \textit{Change Requestor} (Antragsteller), der \textit{Change Manager} (Verantwortlicher für den Prozess) sowie das \textit{Change Advisory Board} (CAB), das den Change Manager berät. Für Notfälle existiert zusätzlich ein \textit{Emergency Change Advisory Board} (ECAB).\footnote{Vgl. \cite{S_TOPdeskChangeManagement}, Abschnitt: What kind of IT changes are there? und Roles and responsibilities IT Change Management.}
...
Neben der Technik erfordern KI-Anwendungen auch administrative und organisatorische Schutzmaßnahmen. Dazu gehört, dass Mitarbeitende regelmäßig geschult und sensibilisiert werden, um das Bewusstsein für Datenschutz und IT-Sicherheit zu stärken.\footnote{Vgl. \hyperref[sec:Anhang3]{Anhang 3, Frage 11.}} Ebenso ist es notwendig, die implementierten Sicherheitsmaßnahmen in festgelegten Abständen zu überprüfen, um deren Wirksamkeit sicherzustellen. Ein weiteres Element sind Notfallpläne, die es erlauben, im Falle eines Sicherheitsvorfalls schnell und effektiv zu reagieren, sodass der Geschäftsbetrieb nicht dauerhaft beeinträchtigt wird.\footnote{Vgl. \cite{S_Fabarius2023}, S. 95–96.}
...
Bei den BWB werden bestehende Regelwerke, die schon für Cloud-Anwendungen angepasst wurden, aktuell auf ihre Tauglichkeit für KI geprüft und wo nötig erweitert, damit Kontroll- und Genehmigungsmechanismen weiterhin greifen. werden bestehende Regelwerke, die bereits für Cloud-Anwendungen angepasst wurden, auf ihre Tauglichkeit für KI geprüft und erweitert. \footnote{Vgl. \hyperref[sec:Anhang3]{Anhang 3, Frage 10.}} Ergänzend wurde ein Strategieprojekt gestartet, in dem IT, Datenschutz, Sicherheit und Strategie gemeinsam Leitlinien für eine unternehmensweite KI-Nutzung entwickeln, um klare Prozesse, Verantwortlichkeiten und Schutzmaßnahmen sicherzustellen.\footnote{Vgl. \hyperref[sec:Anhang3]{Anhang 3, Frage 9.}}
