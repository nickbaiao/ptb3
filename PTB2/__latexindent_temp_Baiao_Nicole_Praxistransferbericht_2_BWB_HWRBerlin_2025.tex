...
\begin{itemize}
    ...
    \item Vorhandensein von KI-Funktionen.\footnote{Vgl. \hyperref[sec:Anhang1]{Anhang 1.}}
\end{itemize}
...
Datenschutz ist Teil der Vertraulichkeits- und Integritätsthematik. Wir arbeiten eng mit den Datenschützern zusammen, prüfen, ob personenbezogene Daten verarbeitet werden, und leiten ggf. eine Datenschutz-Folgenabschätzung ein. Mit IT-Security ermitteln wir die Sicherheitsanforderungen gemeinsam. Compliance kläre ich mit den Fachbereichen – z. B. ob es gesetzliche Vorgaben gibt. Ich moderiere den gesamten Prozess und stelle sicher, dass alle Aspekte berücksichtigt werden.
...
\textbf{Frage 5:} Wie sind Sie im Fall der Adobe Creative Cloud mit den integrierten KI-Funktionalitäten vorgegangen? \\[0.5em]
...
\textbf{Frage 6:} Welche Vorgehensweisen haben sich in Ihrer Praxis bewährt? \\[0.5em]
...
\textbf{Frage 7:} Welche besonderen Herausforderungen gab es dabei? \\[0.5em]
...
\textbf{Frage 8:} Welche Faktoren waren entscheidend, um eine Lösung zu finden? \\[0.5em]
...
\textbf{Frage 9:} Welche Maßnahmen sind entscheidend, um KI-Funktionen in Cloud-Diensten sicher einzusetzen? \\[0.5em]
...
\textbf{Frage 10:} Welche Rolle spielen Governance-Modelle oder Freigabeprozesse? \\[0.5em]
...
\textbf{Frage 11:} Wie wichtig ist die Sensibilisierung und Schulung der Mitarbeitenden? \\[0.5em]
...
\textbf{Frage 12:} Wie lässt sich Risikomanagement für KI gestalten? \\[0.5em]
...
\textbf{Frage 13:} Was sollten Unternehmen bei der Einführung von KI-Software beachten? \\[0.5em]
...
\textbf{Frage 14:} Was empfehlen Sie speziell den Berliner Wasserbetrieben? \\[0.5em]
