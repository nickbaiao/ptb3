...
Vor diesem Hintergrund gewinnt die Nutzung von Cloud-Software zunehmend an Bedeutung. Am Beispiel der Adobe Creative Cloud zeigt sich, dass moderne KI-Funktionalitäten\footnote{Vgl. \cite{S_AdobeAI}.} erhebliche Chancen für Effizienzsteigerungen bieten,\footnote{Vgl. \cite{S_Ambient}.} gleichzeitig jedoch auch Risiken mit sich bringen. Besonders relevant ist die Frage, wie bestehende Softwareprodukte erweitert und skaliert werden können, sodass keine vollständige Neubeschaffung erforderlich wird.
