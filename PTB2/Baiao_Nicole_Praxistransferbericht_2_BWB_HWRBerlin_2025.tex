...
Nur wenn Ziele, Hintergründe und Auswirkungen klar vermittelt werden, entsteht Akzeptanz und Beteiligung. Bei Softwareanpassungen zeigt sich, dass Change Management Technik und soziale Aspekte gleichermaßen berücksichtigen muss.\footnote{Ebenda, S.~42--43.} Mit diesen Elementen entsteht die Grundlage, die wir später für das Verständnis und die Anwendung in der Praxis benötigen.
...
Die bisherigen Schritte lassen sich den Phasen einer Softwareeinführung zuordnen: Die Bedarfsaufnahme entsprach der Projektvorbereitung, die Analyse mit Excel, Schulzbedarf und Erstellung des Memos der Planungsphase. Auswahl und Rollout stehen noch aus, erste Alternativen wurden jedoch bereits geprüft. \footnote{Vgl. \cite{pureconsultant2023}.}
...
\textbf{Interviewer:} Nicole Camille Baião \\
\textbf{Befragte:} Carla Marcus-Schulz (Risiko-Managerin) \\
\textbf{Datum:} 08. September 2025 \\
\textbf{Ort:} Berliner Wasserbetriebe, Neue Jüdenstraße 2, 10179 Berlin 

\subsection*{Einstieg in das Thema}

\textbf{Frage 1:} Könnten Sie sich bitte kurz vorstellen und Ihre Abteilung und Rolle im Sicherheitsmanagement erläutern?  

Mein Name ist Carla Marcus-Schulz. Ich arbeite seit fünf Jahren in der Abteilung Strategie und Unternehmensentwicklung, in der Gruppe Sicherheit. Diese Gruppe hat das Ziel, die physische Sicherheit sowie Cyber- und IT-Security im Unternehmen taktisch-strategisch zu organisieren und zum Teil auch operativ zu unterstützen. In meiner Rolle kümmere ich mich vor allem um neue Anwendungen im Haus: Ich führe eine Schutzbedarfsfeststellung durch und schätze die Sicherheitsrisiken für jede neue Anwendung ab. Konkret bedeutet das, dass wir uns bei jeder neuen Software fragen: Was bedeutet diese Anwendung für die Wasserbetriebe? Wie wollen wir die Anwendung nutzen? Brauchen wir dafür zusätzliche Sicherheitsvorkehrungen oder reichen die Standard-Sicherheitsmaßnahmen aus? Diese Fragen kläre ich gemeinsam mit den Fachbereichen, bevor die Anwendung in Betrieb geht.  
...
Als bei uns das erste Mal KI-Funktionalitäten – konkret bei der Adobe Creative Cloud – aufgekommen sind, hatten wir zunächst keine speziellen Kriterien dafür definiert. Wir haben uns daher an den Kriterien orientiert, die wir immer bei neuen IT-Anwendungen nutzen. Im Rahmen der Schutzbedarfsfeststellung betrachten wir vor allem die klassischen Schutzziele: Vertraulichkeit, Verfügbarkeit und Integrität der Daten und Systeme. (Authentizität spielt in unserem Kontext ebenfalls eine Rolle.) Diese Kriterien sind eher allgemein gehalten und nicht speziell auf KI zugeschnitten. Deshalb war ich mir unsicher, ob sie für die Bewertung der KI-Funktionen ausreichen. Wir haben daraufhin erst einmal einen Workshop angesetzt – also ein ausführliches Gespräch mit allen Beteiligten – um genau festzulegen, was wir bei Software mit KI-Komponenten bewerten und in welchem Umfang. Im Ergebnis nutzen wir weiterhin unser bewährtes Schema der Schutzbedarfsfeststellung, passen es aber bei Bedarf an, um den Besonderheiten von KI-Funktionen gerecht zu werden.  

\textbf{Frage 3:} Welche Rolle spielen hierbei Datenschutz, IT-Sicherheit und Compliance-Anforderungen?  

Datenschutz, IT-Sicherheit und Compliance binden wir von Anfang an eng in die Bewertung ein – sie spielen eine sehr wichtige Rolle. Konkret ist der Datenschutz bei der Bewertung insbesondere der Vertraulichkeit und Integrität einer Anwendung involviert. Ich stehe im engen Austausch mit unseren Datenschutzbeauftragten. Im Zuge jeder Schutzbedarfsfeststellung frage ich zum Beispiel ab, ob personenbezogene Informationen verarbeitet werden und wenn ja, welche. Das Ergebnis meiner Analyse – also alle sicherheitsrelevanten Informationen, die ich gesammelt habe – geht anschließend an das Datenschutz-Team. Diese Informationen bilden dort die Grundlage für eine Datenschutz-Folgenabschätzung gemäß DSGVO. Auf diese Weise stellen wir sicher, dass Datenschutzaspekte voll berücksichtigt werden.  

Die IT-Sicherheit ist ebenfalls von Beginn an mit im Boot. Ich selbst treffe letztlich keine Entscheidungen im Alleingang, sondern verstehe mich als Moderatorin im Prozess. Meine Aufgabe ist es, sicherzustellen, dass für jedes neue Vorhaben eine Schutzbedarfsfeststellung durchgeführt wird. Das Ganze ist bei uns fest in das Projekt- bzw. Anforderungsmanagement der IT integriert. Die IT-Abteilung sammelt zunächst alle Anforderungen und Bedarfe für ein neues Projekt. Im weiteren Projektverlauf gibt es dann explizit den Schritt, die Sicherheitsanforderungen zu bestimmen: Ich leite aus der Schutzbedarfsfeststellung konkrete Sicherheitsanforderungen ab. Daraufhin finden gemeinsame Termine mit der IT-Sicherheit und dem Datenschutz statt, zusammen mit denjenigen, die die Anwendung einführen wollen. So kommen alle relevanten Stellen frühzeitig zusammen, um über Risiken und Maßnahmen zu entscheiden.  

Compliance-Anforderungen beziehe ich ebenfalls in meine Abfragen ein. Das heißt, ich frage die Bedarfsträger (also die Fachabteilungen), warum wir diese neue Anwendung brauchen. Gibt es vielleicht bestimmte vertragliche oder gesetzliche Vorgaben, die dahinterstehen? Darüber hinaus schaue ich, ob die Anwendung Teil unserer kritischen Infrastruktur ist oder ob sie unter sicherheitsrelevante Gesetze fällt. Wenn ja, müssen natürlich entsprechende Compliance-Vorgaben beachtet werden. Diese Anforderungen kommen teils aus den Fachbereichen selbst, teils ergeben sie sich aus einschlägigen IT-Sicherheitsgesetzen. Alles in allem arbeite ich also sehr eng mit Datenschutz, IT-Sicherheit und anderen relevanten Bereichen zusammen, damit am Ende alle Vorschriften eingehalten werden und das Unternehmen abgesichert ist.  

\textbf{Frage 4:} Gibt es spezielle Prüfverfahren oder Checklisten, die Sie im Unternehmen einsetzen?  

Ja, wir haben ein festes Verfahren etabliert. Unsere Schutzbedarfsfeststellungen folgen einer standardisierten Checkliste, die im IT-Prozess hinterlegt ist. Man kann sich das wie einen Laufzettel vorstellen, an dem sich alle Beteiligten orientieren. In dieser Checkliste sind alle Prüfpunkte aufgeführt – von den zu schützenden Informationen über die einzuhaltenden Sicherheitsstandards bis hin zu Datenschutz- und Compliance-Fragen. Dieses strukturierte Vorgehen hat sich absolut bewährt. Es stellt sicher, dass wir bei jeder neuen Anwendung die gleichen Schritte durchlaufen und nichts Wichtiges vergessen. Da wir dieses Verfahren bereits im Unternehmen verankert haben, mussten wir es für KI-Funktionen nicht komplett neu erfinden, sondern erweitern es nur um spezifische Punkte, wo nötig.  
...
Die Adobe Creative Cloud mit ihren KI-Funktionen war für uns einer der komplexesten Fälle bisher. Zunächst musste ich mir eingestehen, dass die Anwendung extrem umfangreich ist. Die erste Frage war also: Wie bekommen wir die Komplexität in den Griff? Bewerten wir alles oder konzentrieren wir uns auf bestimmte Teile? Die Antwort hängt stark davon ab, wie die Fachabteilungen die Creative Cloud nutzen wollen. Deswegen haben wir uns zusammengesetzt – auch mit deiner Vorbereitung, Nicole – und ausführlich diskutiert. Wir haben uns darauf geeinigt, zunächst einmal das Gesamtprodukt zu betrachten, also die Adobe Cloud als Ganzes, statt nur einzelne Funktionen daraus. Daraufhin haben wir wie üblich eine Schutzbedarfsfeststellung durchgeführt. Mit den Ergebnissen wollen wir im Rahmen des Anforderungsmanagements in eine weitere Runde gehen, also noch einmal mit IT und Datenschutz im Detail sprechen. Im Moment ist der Prozess noch nicht abgeschlossen.
...
Aus meiner Erfahrung hat es sich bewährt, frühzeitig und strukturiert vorzugehen. Ein zentraler Erfolgsfaktor ist unser Verfahren der Schutzbedarfsfeststellung. Dieses hat sich bei jeder neuen Softwareeinführung – ob mit oder ohne KI – als sehr hilfreich erwiesen. Es ist wichtig, alle relevanten Stakeholder früh an einen Tisch zu holen – Security, Datenschutz, IT, Fachabteilung. So verhindern wir, dass wichtige Anforderungen übersehen werden. Zudem passen wir unsere Methoden stetig an neue Technologien an. Ein Beispiel: Vor ein paar Jahren haben wir unser Bewertungsverfahren auf Cloud-Anwendungen zugeschnitten. Ähnlich gehen wir jetzt bei KI vor. Unsere Methodik bleibt gleich – Risiken analysieren, Kriterien definieren, Maßnahmen ableiten – aber wir erweitern sie gezielt für KI. Hilfreich ist auch, externe Rahmenwerke und Best Practices zu nutzen, etwa den EU AI Act. Am Ende ist Teamwork entscheidend: bereichsübergreifende Zusammenarbeit und kontinuierliches Lernen.  
...
Eine große Herausforderung war, dass KI-Funktionen Neuland bedeuten – es fehlen Standards und Erfahrungswerte. Die Kombination Cloud und KI ist neu. Bisher existieren keine unternehmensinternen Richtlinien speziell zur KI-Nutzung. Wir mussten erst definieren, welche Kriterien und Sicherheitsanforderungen KI mit sich bringt. Auch die Datentransparenz war schwierig: Wohin fließen unsere Daten, wenn wir KI-Features nutzen? Wir mussten sicherstellen, dass keine sensiblen Daten unkontrolliert abfließen. Da viele KI-Dienste wie Black Boxes wirken, war das besonders kritisch. Mögliche Angriffsszenarien (Datenvergiftung, Manipulation von Modellen) wurden bisher nicht abgedeckt – das mussten wir ergänzen. Insgesamt betreten wir Neuland, entwickeln neue Kriterien und orientieren uns extern, um nichts zu übersehen.  

\textbf{Frage 8:} Welche Faktoren waren letztlich entscheidend, um eine Lösung oder eine Entscheidung zu finden?  

Letztlich läuft es auf eine saubere Risikoabwägung hinaus. Ein entscheidender Faktor ist das Ergebnis unserer Schutzbedarfsfeststellung und Risikoanalyse. Dabei fragen wir: Wie abhängig sind wir von der Anwendung? Welche Schäden könnten entstehen? Wenn nur handhabbare Risiken bestehen, kann die Anwendung mit Auflagen eingeführt werden. Wenn deutliche Risiken bestehen, müssen wir Maßnahmen ergreifen oder im Extremfall den Einsatz ablehnen. Die Software an sich ist selten „gefährlich“ – entscheidend sind die Risiken ihres Einsatzes.  

In unserem konkreten Fall Adobe Creative Cloud entscheidet das natürlich nicht eine Person allein. Die Entscheidung wird für das Unternehmen getroffen, basierend auf unseren Vorarbeiten. Mein Beitrag – die Schutzbedarfsfeststellung – ist dabei ein Baustein der Entscheidungsfindung. Dieses Ergebnis fließt mit ein und zeigt auf, wie kritisch die Anwendung für uns ist und wo potenzielle Gefahren liegen. Man darf nämlich eins nicht vergessen: Die Software an sich ist selten „gefährlich“. Es geht immer um die Risiken, die mit ihrem Einsatz verbunden sind – also was passieren kann, wenn z. B. ein Sicherheitsvorfall eintritt oder Daten abfließen. Wenn wir festgestellt haben, diese Risiken sind vertretbar und beherrschbar, dann haben wir im Prinzip schon die Grundlage für die Lösung gelegt. Dann können wir empfehlen: Ja, wir können das tun, unter folgenden Bedingungen. Wenn nicht, müssen wir andere Wege finden. Aber in den meisten Fällen gibt uns die strukturierte Risikoanalyse die entscheidenden Hinweise dafür, wie die Lösung aussieht – zum Beispiel welche extra Sicherheitsmaßnahmen nötig sind oder welche Einschränkungen gelten sollten. Das sind letztlich die Faktoren, die den Ausschlag geben: Wie hoch ist das Risiko und wie können wir es vertretbar machen? Darauf basiert die Entscheidung im Unternehmen.
...
Aus Sicherheitsmanagement-Sicht gibt es ein ganzes Maßnahmenbündel. Zunächst muss geprüft werden, welche Daten verarbeitet werden. Datenklassifizierung und -sparsamkeit sind entscheidend. Dann ist ein ganzheitlicher Ansatz notwendig – alle Phasen vom Anforderungsmanagement bis zum Betrieb müssen Sicherheitsaspekte einbeziehen. Exit-Strategien sind wichtig: Was tun, wenn der Anbieter den Service ändert oder einstellt? Aktuell erarbeiten wir eine KI-Strategie in einem bereichsübergreifenden Projekt. Entscheidend ist, systematisch und proaktiv vorzugehen, Daten genau zu prüfen, Stakeholder einzubeziehen und das Thema strategisch zu verankern.  

\textbf{Frage 10:} Welche Rolle spielen dabei interne Regelwerke wie Governance-Modelle oder Freigabeprozesse?  

Eine sehr große Rolle. Bei den Wasserbetrieben existieren bereits Governance-Modelle und Freigabeprozesse für IT-Systeme. Mit KI müssen wir prüfen, ob diese ausreichen, und sie erweitern, wo nötig. Wir überprüfen aktuell alle relevanten Richtlinien. Vieles können wir übernehmen, aber an einigen Stellen braucht es Erweiterungen. Wichtig ist, dass Governance und Prozesse mitwachsen.  

\textbf{Frage 11:} Inwiefern ist die Sensibilisierung und Schulung der Mitarbeitenden ein zentraler Erfolgsfaktor?  

Die Sensibilisierung und Schulung der Mitarbeitenden ist absolut zentral. KI-Kompetenz der Belegschaft ist entscheidend. Es reicht nicht, nur Richtlinien zu haben – die Mitarbeitenden müssen verstehen, was erlaubt ist, was nicht und warum. KI-Tools sind verlockend, daher braucht es Bewusstsein, dass Daten unser „Gold“ sind. Deshalb investieren wir viel in Schulung und Sensibilisierung.  

\textbf{Frage 12:} Wie lässt sich aus Ihrer Sicht ein wirksames Risikomanagement speziell für KI-Anwendungen gestalten?  

Wir knüpfen an unser bestehendes Risikomanagement an. Risiken identifizieren, bewerten, behandeln – das bleibt. Für KI erweitern wir die Kriterien, z. B. Manipulation von Trainingsdaten oder Fehlentscheidungen automatisierter Prozesse. Es geht nicht darum, ein neues System zu erfinden, sondern unser bewährtes Risikomanagement anzupassen.  
...
Unternehmen sollten zuerst den Mehrwert der KI klären. KI einzusetzen, nur weil es Trend ist, wäre falsch. Man muss den Nutzen für das Unternehmen identifizieren. Zweitens ist der Umgang mit Daten zentral: Welche Daten geben wir nach außen? Besonders bei Cloud-KI ist das kritisch. Drittens braucht es KI-Kompetenz in der Belegschaft – Schulungen, Sensibilisierung, klare Regeln. Und viertens sollten Prinzipien wie „Security by Design“ und „Privacy by Design“ gelten, mit Tests, Pilotphasen und Validierungen.  
...
Ich empfehle, weiter auf Schulungen, Leitfäden und Kommunikation zu setzen. Jeder Mitarbeitende sollte die Basics über KI kennen. Außerdem sollten wir aus jedem KI-Fall lernen und Erfahrungen dokumentieren. Mit einem kontinuierlichen Verbesserungsprozess bauen wir Schritt für Schritt einen Wissensschatz auf. Ich bin optimistisch: Wenn wir Strategie, Prozesse, Schulung und Lernen beherzigen, werden wir zukünftige KI-Projekte erfolgreich und sicher meistern.  
