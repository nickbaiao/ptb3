...
% --- Untertitel ---
{\Large Praxistransferbericht III} \\
...
% === Einleitung ===
\section{Einleitung}
Die Berliner Wasserbetriebe (BWB) sind das größte Wasser- und Abwasserversorgungsunternehmen Deutschlands und zählen zu den größten Arbeitgebern in Berlin. Mit rund 4.800\footnote{Vgl. \cite{BWB_Arbeitgeber}.} Mitarbeitenden und zahlreichen Fachabteilungen agiert das Unternehmen in einem komplexen organisatorischen Umfeld mit hohen regulatorischen Anforderungen, in dem IT-Abteilungen eine zentrale Rolle bei der Unterstützung und Weiterentwicklung digitaler Arbeitsprozesse einnehmen.
...
\begin{tabular}{p{8cm}}
    \normalsize{Berlin, den 28. Februar 2026.} \\[0.5cm]
