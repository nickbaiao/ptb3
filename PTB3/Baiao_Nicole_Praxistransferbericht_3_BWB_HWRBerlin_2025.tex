...
\begin{itemize}
    ...
    \item \textbf{Risiken (Threats):} Ein Risiko ist die Wahrnehmung von Redundanz: Wird Planner oder To Do als doppelt zu bestehenden Tools empfunden, weil bereits andere Tools mit ähnlichem Funktionsumfang im Einsatz sind, sinkt die Motivation zur Nutzung. Zudem können wenig differenzierte Schulungen Skepsis gegenüber neuen Anwendungen verstärken – insbesondere bei älteren Mitarbeitenden, die sich in ihrer gewohnten Arbeitsweise gut eingespielt fühlen und wenig Änderungswunsch äußern.\footnote{Vgl. \hyperref[sec:Anhang5]{Anhang 5}, Frage 5} 
  \end{itemize}
